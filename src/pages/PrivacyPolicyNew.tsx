  ...
  return (
    ...
    >
      ...
      <Section id="data-sharing" title="Data Sharing" icon={<Users size={20} />}>
        <p>
          We take data privacy seriously and only share your information in limited circumstances. Here's our approach to data sharing:
        </p>

        <h3 className="text-lg font-semibold mb-4" style={{ color: '#1a1a1a' }}>We Do Not Sell Your Data</h3>
        <Callout type="success" title="Our Promise">
          We never sell your personal information to third parties for marketing purposes. Your data is used only to provide and improve our services.
        </Callout>
