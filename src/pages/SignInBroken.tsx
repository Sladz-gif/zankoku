    ...
    try {
      ...
      if (data?.user) {
        ...
        try {
          ...
          setErrorText('Navigation failed. Please try again.');
        }
      } else {
        console.log('NO USER DATA: Authentication succeeded but no user data');
        setErrorText('Authentication succeeded but no user data received.');
        setAuthenticating(false);
      }
    } catch (error) {
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button 
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 z-10 cursor-pointer p-1 rounded hover:bg-white/10 transition-colors" 
